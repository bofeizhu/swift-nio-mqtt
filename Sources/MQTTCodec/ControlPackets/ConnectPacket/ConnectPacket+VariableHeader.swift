...
extension ConnectPacket: VariableHeaderPacket {
    ...
    public struct VariableHeader: HasProperties, MQTTByteRepresentable {
        ...
        /// Connect Flags
        public let connectFlags: ConnectFlags
    ...
    public struct ConnectFlags: RawRepresentable {
        public typealias RawValue = UInt8

        public let cleanStart: Bool

        public let willFlag: Bool

        public let willQoS: QoS

        public let willRetain: Bool

        public let passwordFlag: Bool

        public let userNameFlag: Bool
