#
#  Be sure to run `pod spec lint SwiftNIOMQTT.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/SwiftNIOMQTT"
  ...
  # Or just: spec.author    = "Bofei Zhu"
  # spec.authors            = { "Bofei Zhu" => "bofei.zhu@healthtap.com" }
  # spec.social_media_url   = "https://twitter.com/Bofei Zhu"
